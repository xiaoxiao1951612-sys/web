import { useState, useContext, useEffect } from 'react';
  ...
  import { ArrowLeft, Save, Plus, Image, Calendar, BookOpen } from 'lucide-react';
  ...
  export default function AdminAddProject() {
    ...
    // 使用useState存储新项目数据
    const [project, setProject] = useState<PortfolioItem>({
      id: 0,
      title: '',
      category: '项目',
      description: '',
    ...
    const handleSaveProject = async () => {
      ...
      if (!project.title || !project.category || !project.description || 
          !project.date || project.images.length === 0 || !project.details.overview) {
      ...
      try {
        ...
        if (success) {
          toast.success('项目添加成功，所有访问者将看到最新内容');
        ...
        >
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="ml-4 text-xl font-bold">添加新项目</h1>
            </div>
             <button
